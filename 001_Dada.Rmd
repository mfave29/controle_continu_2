...
plot_abundance = function(physeq,title = "",
  ...
  p1f = subset_taxa(physeq, Phylum %in% c("Planctomycetes"))
  mphyseq = psmelt(p1f)
...
```
```{r}
psOrd = subset_taxa(ps3ra, Order == "Pirellulales")
...
```{r}
psOrd1 = subset_taxa(ps3ra1, Order == "Pirellulales")
plot_abundance1(psOrd1, Facet = "Genus", Color = NULL)
```

```{r}
qplot(sample_data(ps)$profondeur, geom = "histogram",binwidth=20) + xlab("profondeur")
```
