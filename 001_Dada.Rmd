...
Nous observons qu'il y a une grande quantité de bactéries faisant partie du phylum des Proteobacteria maos également beaucoup de bactéries non répertoriées. Bien que ce tableau présenté ne concerne que les 6 premiers taxons, il s'avère que le tableau global comporte plus de taxons, dont beaucoup d'autres Proteobacteries et de Bacteroidota. 
...
filterPhyla = c("Campilobacterota", "Dependentiae")
...
plot_abundance = function(physeq,title = "",
  ...
  ggplot(data = mphyseq, mapping = aes_string(x = "",y = "Abundance",
